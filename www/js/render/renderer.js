...
//        console.log(nxtTickRatio);
    ...
    Renderer.prototype.drawAnimation = function () {
        ...
        for (var key in this.dynamicObjects) {
            ...
            this.dynamicLayerCtx.drawImage(this.subImage, anim.xPoint + (anim.width * elem.currentFrame), anim.yPoint, anim.width, anim.height,
    ...
    Renderer.prototype.setBackground = function (info) {
        for (var x = 0; x < this.xTiles; x++) {
            this.backgroundCtx.drawImage(this.subImage, info.subImage.xPoint, info.subImage.yPoint, info.subImage.width, info.subImage.height,
    ...
    Renderer.prototype.addDynamic = function (elem) {
        ...
        this.dynamicLayerCtx.drawImage(this.subImage, anim.xPoint, anim.yPoint, anim.width, anim.height,
            elem.initX * this.tileWidth, elem.initY * this.tileWidth, anim.tileWidth * this.tileWidth, anim.tileHeight * this.tileWidth);
    };
    ...
    Renderer.prototype.addStatic = function (elem) {
        this.staticBufferCtx.drawImage(this.subImage, elem.subImage.xPoint, elem.subImage.yPoint, elem.subImage.width, elem.subImage.height,
            elem.initX * this.tileWidth, elem.initY * this.tileWidth, elem.subImage.tileWidth * this.tileWidth, elem.subImage.tileHeight * this.tileWidth);
    };
